...
// //               </button>
// //               <button 
// //                 onClick={() => window.location.href = `tel:${contactInfo?.phone?.replace(/\D/g, '') || '5551234567'}`}
// //                 className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-105"
// //               >
// //                 Call Us: {contactInfo?.phone || "(555) 123-4567"}
// //               </button>
// //             </div>
// //           </div>
// //         </section>
...
//                   className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200"
//                 />
//                 <p className="text-xs text-gray-500 mt-1">Enter your mobile number (any length)</p>
//               </div>
...
export default function SushiBoatPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage({ type: 'success', text: t('Thank you! Your Sushi Boat reservation request has been submitted successfully.') });
        setFormData({
          name: '',
          email: '',
          mobileNumber: '',
        ...
        setMessage({ 
          type: 'error', 
          text: result.errors?.[0] || result.message || t('Failed to submit your request. Please try again.') 
        });
      }
    } catch (error) {
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative bg-gradient-to-br from-gray-900 to-black py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              {t('The Ultimate Japanese Dining Experience for Special Occasions')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                onClick={() => document.getElementById('sushi-boat-form')?.scrollIntoView({ behavior: 'smooth' })}
        ...
        <section id="sushi-boat-details" className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold text-gray-900 mb-4">
                {t('We are more than delivery and takeaway')}
              </h2>
              <div className="w-24 h-1 bg-red-500 mx-auto"></div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl">
                  <img
                    ...
                    alt={t('Sushi Boat - Premium Japanese Experience')}
                    className="w-full h-full object-cover"
                  />
                </div>
                {/* Decorative elements */}
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    {t("It's not just sushi. It's an event.")}
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    {t("300 pieces, a boat, and no room for amateurs. Made to share (or pretend to), with everything included: chopsticks, soy, wasabi, sauceboats, and envious glances.")}
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    {t("Our Sushi Boat is the perfect choice for any celebration worth remembering (and sharing). It serves a large group, or just your most ambitious desires. It's all about freshness. And about doing things big.")}
                  </p>
                  
                  {/* Sushi Boat Composition */}
                  <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-2xl border border-red-100">
                    <h4 className="text-xl font-bold text-gray-900 mb-3">
                      {t('Sushi Boat Composition')}
                    </h4>
                    <ul className="text-gray-700 space-y-2">
                      <li>• {t('300 premium sushi pieces')}</li>
                      <li>• {t('Traditional wooden boat presentation')}</li>
                      <li>• {t('Assorted nigiri, sashimi, and specialty rolls')}</li>
                      <li>• {t('Complete with chopsticks, soy sauce, and wasabi')}</li>
                      <li>• {t('Serves 8-12 people')}</li>
                      <li>• {t('48-hour advance booking required')}</li>
                    </ul>
                  </div>

                  <div className="text-center">
                    <p className="text-2xl font-bold text-red-600 mb-2">
                      {t('Talk to us and book your Sushi Boat now')}
                    </p>
                    <div className="w-32 h-1 bg-red-500 mx-auto"></div>
                  </div>
                </div>
        ...
        <section id="sushi-boat-form" className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                {t('Book Your Sushi Boat Experience')}
              </h2>
              <p className="text-xl text-gray-600">
                {t("Fill out the form below and we'll get back to you within 24 hours to confirm your reservation")}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-gray-50 p-8 rounded-3xl shadow-lg">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200"
                />
                <p className="text-xs text-gray-500 mt-1">{t('Enter your mobile number (any length)')}</p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  placeholder={t('Enter all relevant details such as date, time of delivery and collection, and number of people')}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 resize-none"
                />
              </div>
              ...
              >
                {isLoading ? (
                  ...
                  t('Book My Sushi Boat Experience')
                )}
              </button>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-500">
                  {t("We'll contact you within 24 hours to confirm your Sushi Boat reservation")}
                </p>
              </div>
            </form>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 bg-white rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">{t('48-Hour Notice')}</h4>
                <p className="text-gray-600 text-lg">{t('Book at least 48 hours in advance for the perfect preparation and fresh ingredients')}</p>
              </div>
              ...
              <div className="text-center p-8 bg-white rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">{t('Serves 8-12 People')}</h4>
                <p className="text-gray-600 text-lg">{t('Perfect for parties, celebrations, corporate events, and special gatherings')}</p>
              </div>
              ...
              <div className="text-center p-8 bg-white rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">{t('Fresh Daily Preparation')}</h4>
                <p className="text-gray-600 text-lg">{t('Prepared with the freshest ingredients on the day of your event for optimal quality')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-br from-gray-900 to-black">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-white mb-6">
              {t('Ready to make your event unforgettable?')}
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              {t('Book your Sushi Boat today and create memories that will last a lifetime')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                onClick={() => document.getElementById('sushi-boat-form')?.scrollIntoView({ behavior: 'smooth' })}
              ...
              <button 
                ...
                className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-105"
              >
                {t('Call Us')}: {contactInfo?.phone || "(555) 123-4567"}
              </button>
            </div>
          </div>
        </section>
