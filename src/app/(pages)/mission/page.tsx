...
// // //             {/* Careers Section - Keep only this static section */}
// // //             <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-20">
// // //               {/* Image */}
// // //               <div className="relative rounded-3xl overflow-hidden shadow-2xl">
// // //                 <img
...
// // //         {/* CTA Section - Keep the newsletter section */}
// // //         {/* <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
// // //           <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
// // //             <h2 className="text-4xl font-bold text-gray-900 mb-6">
// // //               Stay Updated with SushiMaster
...
// //                     sushi and eager to grow within a relaxed team focused on the
// //                     art of Japanese cuisine. Here, you'll hone your skills,
// //                     explore new flavors, and work in a fast-paced, yet always
// //                     positive environment!
// //                   </p>
// //                   <p>
// //                     If you have knife skills, attention to detail, and a desire
// //                     to learn (or perfect) the art of sushi, we want to hear from
// //                     you!
// //                   </p>
// //                   <p className="font-semibold text-gray-900">
// //                     Submit your application and come join our kitchen.🍙
...
//                 {/* ✅ Updated Careers Button → Link to /join-our-team */}
//                 <Link
//                   href="/join-our-team"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-20">
              ...
              <div className="space-y-6">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  {t("Let's get to work... Or rather, to sushi🍣")}
                </h2>
