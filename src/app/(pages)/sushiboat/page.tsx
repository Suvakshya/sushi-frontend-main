      ...
      if (result.success) {
        ...
        setMessage({
          ...
          text:
            result.errors?.[0] ||
            result.message ||
            t("Failed to submit your request. Please try again."),
        });
      }
    } catch (error) {
      setMessage({
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() =>
                  document
                    .getElementById("sushi-boat-form")
              ...
              <button
                onClick={() =>
                  document
                    .getElementById("sushi-boat-details")
                    ?.scrollIntoView({ behavior: "smooth" })
                }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl">
                  {/* <img
                      src="/HSS-barco-27-3-scaled.jpeg"
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-2xl border border-red-100">
                    ...
                    <ul className="text-gray-700 space-y-2">
                      ...
                      <li>
                        • {t("Assorted nigiri, sashimi, and specialty rolls")}
                      </li>
                      <li>
                        • {t("Complete with chopsticks, soy sauce, and wasabi")}
                      </li>
        ...
        <section id="sushi-boat-form" className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form
              ...
              className="space-y-6 bg-gray-50 p-8 rounded-3xl shadow-lg"
            >
              {message.text && (
                <div
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {t("Enter your mobile number (any length)")}
                </p>
              </div>
              ...
              <button
                onClick={() =>
                  (window.location.href = `tel:${
                    contactInfo?.phone?.replace(/\D/g, "") || "5551234567"
                  }`)
                }
                className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-105"
              >
